...
class MimeMagic
  ...
  TYPES = {
    ...
    'text/x-dbus-services' => [%w(services), %w(text/plain), 'D-Bus services file'],
    ...
    'text/x-systemd-unit' => [%w(automount device mount path scope services slice socket swap target timer), %w(text/plain), 'systemd unit file'],
